...
public class UserController {
    ...
    @PutMapping("/promote")
    // 권한 검사 (해당 권한이 아니면 인가처리 거부 403 에러)
    ...
    private MediaType findExtensionAndGetMediaType(String filePath) {
        ...
        // 파일 경로에서 확장자 추출하기
        // D:/todo_upload/ajdklfjasklfjaskdf_abc.jpg
        String ext
